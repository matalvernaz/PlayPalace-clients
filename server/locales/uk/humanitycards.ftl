...
# Judge announcement
hc-judge-is = { $count ->
    [one] { $names } — картковий цар.
   *[other] { $names } — карткові царі.
}
...
# Results
hc-winner-announcement = { $player } отримує { $points } { $points ->
    [one] очко
   *[other] очок
} за { $text }.
...
hc-waiting-for = Очікування, поки { $names } подадуть карти.
hc-all-submitted-waiting-judge = Усі гравці вже подали карти. Очікування рішення від { $judge }.
hc-waiting-for-judges = Очікування рішення від { $names }.
