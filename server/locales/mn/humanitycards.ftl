...
hc-waiting-for = { $names } илгээхийг хүлээж байна.
hc-all-submitted-waiting-judge = Бүх тоглогч хариугаа илгээсэн. { $judge } шүүхийг хүлээж байна.
hc-waiting-for-judges = { $names } шүүхийг хүлээж байна.
