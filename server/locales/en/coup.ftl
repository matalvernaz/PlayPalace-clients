...
coup-plays-coup = { $player } coups { $target }!
coup-claims-tax = { $player } claims Duke and takes Tax.
...
coup-cannot-afford-coup = You need at least 7 coins to coup.
...
coup-desc-timer-duration = How long players have to challenge or block before an action resolves
...
coup-desc-mandatory-coup = The coin threshold at which a player must perform a Coup
