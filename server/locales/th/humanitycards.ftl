...
# Judge announcement
hc-judge-is = { $count ->
    [one] { $names } คือซาร์ไพ่
   *[other] { $names } คือซาร์ไพ่
}
...
# Results
hc-winner-announcement = { $player } ได้ { $points } { $points ->
    [one] คะแนน
   *[other] คะแนน
} จาก { $text }.
...
hc-waiting-for = กำลังรอ { $names } ส่งคำตอบ
hc-all-submitted-waiting-judge = ผู้เล่นทุกคนส่งคำตอบแล้ว กำลังรอ { $judge } ตัดสิน
hc-waiting-for-judges = กำลังรอ { $names } ตัดสิน
